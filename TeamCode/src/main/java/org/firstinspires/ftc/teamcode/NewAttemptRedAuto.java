...
@Autonomous(name = "NewAttemptRedAuto")
public class NewAttemptRedAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            if (leftDistance < 40) {
                ...
                //telemetry.update();
                drive(-hex_motor_ticks * 2.5, -hex_motor_ticks * 2.5, -hex_motor_ticks * 2.5, -hex_motor_ticks * 2.5, 0.5);
