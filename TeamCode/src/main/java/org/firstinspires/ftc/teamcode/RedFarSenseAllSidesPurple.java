...
@Autonomous(name = "RedFarSenseAllSidesPurple")
public class RedFarSenseAllSidesPurple extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            RightArmPos = 0;
            sleep(500);
            drive(hex_motor_ticks * 5.8, hex_motor_ticks * 5.8, hex_motor_ticks * 5.8, hex_motor_ticks * 5.8, 0.5);
            ...
            if (leftDistance < 25) {
                ...
                drive(-hex_motor_ticks * 2.2, -hex_motor_ticks * 2.2, -hex_motor_ticks * 2.2, -hex_motor_ticks * 2.2, 0.5);
