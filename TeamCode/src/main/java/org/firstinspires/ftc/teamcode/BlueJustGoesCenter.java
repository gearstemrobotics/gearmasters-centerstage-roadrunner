...
@Autonomous(name = "BlueJustGoesCenter")
public class BlueJustGoesCenter extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            telemetry.update();
            sleep(1000);
            drive(-hex_motor_ticks * 1.4, -hex_motor_ticks * 1.4, -hex_motor_ticks * 1.4, -hex_motor_ticks * 1.4, 0.5);
